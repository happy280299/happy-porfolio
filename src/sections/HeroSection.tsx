    ...
    >
      ...
      <div className="overflow-hidden">
        <FadeIn delay={0.15} y={40}>
          <h1 className="hero-heading font-black uppercase tracking-tight leading-none whitespace-nowrap w-full text-center text-[14vw] sm:text-[15vw] md:text-[16vw] lg:text-[15vw] mt-6 sm:mt-4 md:-mt-5">
            Hi, i&apos;m happy
          </h1>
        </FadeIn>
      </div>
      ...
      <div className="mt-auto flex justify-between items-end px-6 md:px-10 pb-7 sm:pb-8 md:pb-10">
        <FadeIn delay={0.35} y={20}>
          ...
          >
            a front-end developer crafting fast, striking web &amp; web3
            experiences
          </p>
        </FadeIn>
